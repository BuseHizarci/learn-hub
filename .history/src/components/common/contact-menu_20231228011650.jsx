...
import { FaFacebook, FaTwitter, FaInstagram, FaLinkedin, FaPhone } from "react-icons/fa"; // import FaFacebook } from "react-icons/fa";
...
const ContactMenu = (props) => {
  return (
    <Nav {...props}>
      ...
      <NavLink href={config.contact} target="_blank">
        Twitter
        <FaTwitter />
      </NavLink>
